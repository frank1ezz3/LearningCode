...
/*
二阶魔方就是只有2层的魔方 只由8个小方块组成

但是有个逼只喜欢3种颜色 所以把家里的二阶魔方重新涂了颜色
...
请你计算一下 这样的魔方打乱之后一共有多少种不同的状态

如果两个状态经过魔方的整体旋转后，各个面的颜色都一直 ， 则认为是同一种状态
...
//————————————————
//        版权声明：本文为CSDN博主「杉菜酱_」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
//        原文链接：https://blog.csdn.net/qq_45479404/article/details/108862084